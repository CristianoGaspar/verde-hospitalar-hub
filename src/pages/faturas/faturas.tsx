...
import {  ArrowLeft,  Trash2,  Edit,  AlertTriangle,  Download,  Plus,  Search,  Filter,  User,  Clock,  DollarSign,  Activity,  CheckCircle,  XCircle,  Eye,
  SeparatorHorizontal as Separator,  CreditCard,  FileText} from "lucide-react";
...
const Faturas = () => {
  ...
  return (
    <HospitalLayout currentPage="faturas" onPageChange={() => {}}>
      <div className="p-6 space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Faturas</h1>
            <p className="text-muted-foreground">Gerenciar faturas e cobranças de procedimentos</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">R$ {totalAmount.toLocaleString("pt-BR")}</div>
              <p className="text-xs text-muted-foreground">{filteredInvoices.length} faturas</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">R$ {paidAmount.toLocaleString("pt-BR")}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-600">R$ {pendingAmount.toLocaleString("pt-BR")}</div>
              <p className="text-xs text-muted-foreground">
